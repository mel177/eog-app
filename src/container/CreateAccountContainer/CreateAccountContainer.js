...
class CreateAccountContainer extends Component {
    ...
    render() {
        return (
            <CreateAccount create={(username, email, password, password_confirm) => this.props.onCreateAccount(username, email, password, password_confirm)} />
        )
    }
...
const mapDispatchToProps = dispatch => {
    return {
        onCreateAccount: (username, email, password, password_confirm) => {
            axios
